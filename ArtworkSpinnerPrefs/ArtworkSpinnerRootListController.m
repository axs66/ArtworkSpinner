...
#import "ArtworkSpinnerRootListController.h"

void ArtworkSpinnerEnumerateProcessesUsingBlock(void (^enumerator)(pid_t pid, NSString *executablePath, BOOL *stop)) {
...
void ArtworkSpinnerKillAll(NSString *processName, BOOL softly) {
    ArtworkSpinnerEnumerateProcessesUsingBlock(^(pid_t pid, NSString *executablePath, BOOL *stop) {
...
void ArtworkSpinnerBatchKillAll(NSArray<NSString *> *processNames, BOOL softly) {
    ArtworkSpinnerEnumerateProcessesUsingBlock(^(pid_t pid, NSString *executablePath, BOOL *stop) {
...
@implementation ArtworkSpinnerRootListController
...
- (void)respring {
    ArtworkSpinnerBatchKillAll(@[ @"SpringBoard", @"MediaRemoteUI" ], YES);
}
